...
object HtmlTable3 extends App {
  ...
  val ast = TreeParser(html.toString).parse

  implicit val prettyPrint: Boolean = true

  val astToString = ast.toString
  val astPretty = ast.prettyString()
